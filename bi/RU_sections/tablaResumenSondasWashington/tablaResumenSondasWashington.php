<?php
	...
	$sourceJsonFile="RU_sections/tablaResumenSondasWashington/tablaResumenSondasWashington.json";
...
<div id="tablaResumenSondasWashington" style="display: none;" >
	<div id="cabecera1" style="background-color:#8BC34A ">
