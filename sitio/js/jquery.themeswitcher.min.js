 ...
 *
 */
(function(d){d.fn.themeswitcher=function(c){function f(b){if(null!==a.onselect)a.onselect();l.text(a.buttonpretext+" "+b.title);var h=[],c=b.url;c||(h=a.themepath+a.jqueryuiversion+"/",c=h+b.name+"/jquery-ui.css",h=d('link[href^="'+h+'"]').first());h.length?h[0].href=c:d("<link/>").attr("type","text/css").attr("rel","stylesheet").attr("href",c).appendTo("head");d.cookie(a.cookiename,b.name,{expires:a.cookieexpires,path:a.cookiepath});e.find(".jquery-ui-switcher-title").text(a.buttonpretext+
...
themepath:"/sitio/css/themes/",jqueryuiversion:"1.10.3",initialtext:"Switch Theme",buttonpretext:"Theme:",closeonselect:!0,buttonheight:14,cookiename:"jquery-ui-theme",themes:[],additionalthemes:[],onopen:null,onclose:null,onselect:null,cookieexpires:365,cookiepath:"/"};c&&(d.each(c,function(a,b){i[a.toLowerCase()]=b}),d.extend(a,i));var k=a.themes.length?a.themes:[{title:"Black Tie",name:"black-tie",icon:"theme_90_black_tie.png"},{title:"Blitzer",name:"blitzer",icon:"theme_90_blitzer.png"},
