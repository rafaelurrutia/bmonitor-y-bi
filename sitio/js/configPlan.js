...
var $lista1 = $('#plan_groupid_1'), $lista2 = $('#plan_groupid_2');
// lista 1
$('li',$lista1).draggable({
	revert: 'invalid',		
	helper: 'clone',		
...
$lista2.droppable({
	accept: '#plan_groupid_1 > li',
	drop: function(ev, ui) {
		$.deleteLista1(ui.draggable,$lista2);		
	}
});

var plan_plan = $( "#plan_plan" ),
	plan_plandesc = $( "#plan_plandesc" ),
	plan_planname = $("#plan_planname"),
	plan_nacD = $("#plan_nacD"),
	plan_nacDS = $("#plan_nacDS"),
	plan_nacDT = $("#plan_nacDT"),

	plan_nacU = $("#plan_nacU"),
	plan_nacUS = $("#plan_nacUS"),
	plan_nacUT = $("#plan_nacUT"),

	plan_locD = $("#plan_locD"),
	plan_locDS = $("#plan_locDS"),
	plan_locDT = $("#plan_locDT"),

	plan_locU = $("#plan_locU"),
	plan_locUS = $("#plan_locUS"),
	plan_locUT = $("#plan_locUT"),
	
	plan_intD = $("#plan_intD"),
	plan_intDS = $("#plan_intDS"),
	plan_intDT = $("#plan_intDT"),

	plan_intU = $("#plan_intU"),
	plan_intUS = $("#plan_intUS"),
	plan_intUT = $("#plan_intUT"),
	
	plan_sysctl = $("#plan_sysctl"),
	plan_ppp = $("#plan_ppp"),
	
	allFieldsPlan = $( [] ).add( plan_plan ).add( plan_plandesc ).add( plan_planname ),
	tips = $( ".validateTipsPlan" );
...
$( "#modal_plan_delete" ).dialog({
	...
	width: 400,
	modal: true,
	buttons: { "Borrar los planes seleccionados": function() {
	...
	$( "#modal_plan_edit" ).dialog({
		...
		buttons: {
			"Crear plan": function() {
		        ...
		        var plan_plan = $( "#plan_edit_plan" ),
					plan_plandesc = $( "#plan_edit_plandesc" ),
					plan_planname = $("#plan_edit_planname"),
					plan_nacD = $("#plan_edit_nacD"),
					plan_nacDS = $("#plan_edit_nacDS"),
					plan_nacDT = $("#plan_edit_nacDT"),
					allFieldsPlan = $( [] ).add( plan_plan ).add( plan_plandesc ).add( plan_planname ),
