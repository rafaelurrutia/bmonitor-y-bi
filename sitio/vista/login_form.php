	...
	<div class="portlet">
		...
		<div class="portlet-content">
			<table id="tableProfileUSer" style="width: 100%" class="ui-grid-content ui-widget-content">
				<tbody>
					<tr>
						<td class="ui-widget-content"><label for="user_passwd_active">{CURRENT_PASSWORD}</label></td>
						<td class="ui-widget-content">
						<input type="password" name="user_passwd_active" id="user_passwd_active" value="{user_passwd_active}" />
						</td>
					</tr>
					<tr>
