	...
	jQuery(function( ) {
		...
		tableReportMinticGroups.flexigrid({
			...
			colModel : [{
				...
				display : 'Muestras a Realizar',
				name : 'mEESperada',
				width : '100',
				sortable : true,
				align : 'left'
			}, {
				display : 'Muestras Down OK',
				name : 'mDownloadOk',
				width : '100',
				sortable : true,
				align : 'left'
			}, {
				display : 'Muestras Down Fallidas',
				name : 'mDownloadFallidas',
				width : '100',
				sortable : false,
				align : 'left'
			}, {
				display : 'Muestras Up Ok',
				name : 'mUploadOk',
				width : '100',
				sortable : false,
				align : 'left'
			}, {
				display : 'Muestras Up Fallidas',
				name : 'mUploadFallidas',
				width : '100',
				sortable : true,
				align : 'left'
			}, {
				display : 'Vel. prom. Down',
				name : 'vavgdown',
				width : '100',
				sortable : true,
				align : 'left'
                ...
                display : 'Cumplimiento Cantidad Muestras Down OK',
                name : 'cumplimientoDown',
                width : '100',
                sortable : true,
                align : 'left'
            }, {
                display : 'Cumplimiento Cantidad Muestras Up OK',
...
<form id="fmFilterReportQoeMinticGroups">
	<div class="paneles">
		<fieldset>
			<div id="row">
				<label for="grupo" accesskey="g">{GROUP} holaaaaa</label>
				<select name="grupo" id="grupo">
					{option_groups}
				</select>
			</div>
			<div id="row">
				<label for="server" accesskey="g">{SERVER} holaaaa</label>
