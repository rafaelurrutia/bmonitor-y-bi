...
jQuery(function() {
	...
	$.getJSON('/graphc/getGraphOne?idgroups={groupid}&graphid={graphid}&id_host={id_host}&limit={limit}&callback=?&name={series2}',	function(data) {
	...
	function createChart() {
        ...
        var chart_{graphid}_{id_host}_{graph_type} = $('#container_graph_{graphid}_{id_host}_{graph_type}').highcharts('StockChart', {
	    	chart: {
