<script type="text/javascript" src="{url_base}sitio/js/view.graph_index.js"></script>
<style>
	#targetLineBar {
		width: 99%;
		height: 30px;
...
<div style="height: 500px; min-width: 500px" id="graph_ultimafecha_index"></div>